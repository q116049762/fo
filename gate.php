...
*/
define('BOT_TOKEN', 'AAG1bNDGYAxhHMiM_nezLcCguz7GLlC-yfc'); // Replace YOUR TELEGRAM BOT TOKEN to Your BotToken
define('CHAT_ID', '5918599118'); // Replace YOUR CHAT ID to Your Chat ID
